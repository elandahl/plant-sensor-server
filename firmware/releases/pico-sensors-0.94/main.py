...
FIRMWARE_VERSION = "pico-sensors-0.94"

SERVER_URL = secrets.SERVER_URL
SERVER_BASE = SERVER_URL.rsplit("/api/", 1)[0]
NODE_ID = secrets.NODE_ID

# Lab CO2 / FIR calibration: SCD4x updates ~5 s; 10 s keeps fresh samples without
# hammering WiFi. Revert with normal fleet release after calibration.
READ_INTERVAL_S = 10
